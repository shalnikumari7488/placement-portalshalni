    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <a href="studentprofile.php">Open</a>
            </div>

            <div class="row">
                <span>View Available Companies</span>
                <a href="viewcompany.php">Open</a>
            </div>
<div class="row">
                <span>View job</span>
                <a href="viewjob.php">Open</a>
            </div>


            <div class="row">
                <span>Apply for Placement</span>
                <a href="applyjob.html">Apply</a>
            </div>

            <div class="row">
                <span>Check Application Status</span>
                <a href="applicationstatus.php">Check</a>
            </div>
